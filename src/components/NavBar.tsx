        ...
        <>
          {data?.data.map((cat) => (
            <p
              ...
              key={cat.documentId}
              className="capitalize  my-[2px] px-2 text-[14px] hover:underline lg:text-[16px] font-medium lg:font-semibold text-primary hover:text-hoverColor transition ease-in-out cursor-pointer inline-block"
            >
