...
const ModalSearch = () => {
  ...
  return (
    <div className="relative flex justify-center">
      ...
      >
        Search <Search size={16} className=" mt-1" />
      </button>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="relative cursor-default inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
              <h3
              ...
              <form className="mt-4 cursor-default" onSubmit={handleSubmit}>
                <label
                  htmlFor="Name"
