...
const AboutUS = () => {
  return (
    <div className=" ">
      <div className="min-h-[78vh] gap-14 flex-col xl:flex-row flex items-center justify-center container mx-auto px-4 py-8">
        <div className="">
          {" "}
          ...
          <div className="collapse mt-4 bg-sec">
            ...
            <div className="collapse-content">
              <p className=" text-[14px] sm:text-[18px] leading-[20px] sm:leading-[24px] font-medium sm:font-semibold text-white w-[95%]">
                ...
                overall project management, making it a standout project in my
                portfolio.
              </p>{" "}
            </div>
          </div>
        </div>{" "}
        <Image alt="photo" width={400} height={400} src={"/profile.svg"} />
      </div>
    </div>
  );
};
